...
const buttonClassName =
  "flex w-full items-center p-2 text-gray-500 hover:border-r-4 border-color-brand-600 transition-transform duration-300 ease-in-out transform";
  ...
  return (
    <aside className="bg-white border-r border-gray-200 p-5 text-secondaryGray-300">
      <div className="mt-5 border-b-[1px] pb-8">
        ...
        <div className="uppercase text-3xl ml-20 font-extralight text-color-brand-500">
          Manager
        </div>
      </div>
